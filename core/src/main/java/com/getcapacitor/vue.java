...
import com.getcapacitor.Tab3Plugin;
...
public class vue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            bridgeBuilder.addPlugin(Tab3Plugin.class);
    ...
    protected void load() {
        ...
        bridge.setServerBasePath(Env.Companion.getContext().getExternalFilesDir("debug")+"/ui/vue");
        System.out.println("======:"+bridge.getServerBasePath());
